...
class IdentityTracker(Tracker):
    ...
    def update(self, image):
        ...
        x, y, w, h = self.tracker.tracker_inference(image, real_x, real_y, real_w, real_h, self.count, self.number_of_frame, self.count)
        self.count_for_online_train += 1
        if self.count_for_online_train % 3 == 0:
            self.tracker.tracker_update(image, real_x, real_y, real_w, real_h, 1, 100, self.count)
