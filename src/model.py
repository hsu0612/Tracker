...
class VAENet(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Flatten()
        self.fc22 = nn.Linear(2048, 32)
        self.fc23 = nn.Linear(2048, 32)
        self.fc3 = nn.Linear(32, 2048)
    ...
    def forward(self, x):
        ...
        return output, feature_map, mu, logvar, inference, output_fc1
